...
test('parse', async (t) => {
  ...
  await t.test('parses button with data-variant attribute', () => {
    ...
    assert.equal(parsed.button_data_variant_primary.rootAttribute, 'data-variant')
    assert.ok(parsed.button_data_variant_primary.attributes['data-variant'])
    assert.ok(parsed.button_data_variant_primary.attributes['data-variant'].has('primary'))
  })
  ...
  await t.test('parses boolean attributes', () => {
    ...
    assert.ok(parsed.button_data_disabled.booleanAttributes.has('data-disabled'))
  })
  ...
  await t.test('parses complex component with data-component attribute', () => {
    ...
    assert.ok(parsed.div_data_component_card.attributes['data-component'].has('card'))
